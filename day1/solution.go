...
func findThreeEntries(input []int, outcome int) (value1, value2, value3 int) {
	for _, value1 := range input {
		for _, value2 := range input[1:] {
			for _, value3 := range input[2:] {
				if value1 + value2 + value3 == outcome {
...
func mutliplyTwo(value1, value2 int) int {
	return value1 * value2
}

func mutliplyThree(value1, value2, value3 int) int {
	return value1 * value2 * value3
}